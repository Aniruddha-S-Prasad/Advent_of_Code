...
one_in_two = (elf_1_assignments[:, 0] >= elf_2_assignments[:, 0]) & (elf_1_assignments[:, 0] <= elf_2_assignments[:, 1])
# Work for elf_2 contained in work for elf_1
two_in_one = (elf_2_assignments[:, 0] >= elf_1_assignments[:, 0]) & (elf_2_assignments[:, 0] <= elf_1_assignments[:, 1])
